...
//    private Manager manager;
    private EmployeeController employeeLibrary = new EmployeeController(); // The Library will exist as long as the Dart program is running.
    private static GameController gameLibrary = new GameController();  //creating new library for games
